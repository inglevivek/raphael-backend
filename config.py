...
class Config:
    ...
    # AUTH0 CONFIGURATION
    # ==========================================
    AUTH0_DOMAIN = os.getenv('AUTH0_DOMAIN', 'chronos911.us.auth0.com')
    AUTH0_CLIENT_ID = os.getenv('AUTH0_CLIENT_ID', '2nMejHYYamUwL4DlsbJ6zmU4dgZ00PMd')
    ...
    AUTH0_DOMAIN=os.getenv('AUTH0_DOMAIN', 'chronos911.us.auth0.com')
    AUTH0_CLIENT_ID=os.getenv('AUTH0_CLIENT_ID' , '2nMejHYYamUwL4DlsbJ6zmU4dgZ00PMd')
    AUTH0_CLIENT_SECRET=os.getenv('AUTH0_CLIENT_SECRET')  # ✅ REQUIRED: Add your client secret
    AUTH0_AUDIENCE=os.getenv('AUTH0_AUDIENCE', 'https://chronos911.us.auth0.com/api/v2/')
